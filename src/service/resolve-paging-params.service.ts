...
import { SimPaginationUtil } from './pagination-util.service';

@Injectable({
    providedIn: 'root'
})
export class SimResolvePagingParams implements Resolve<any> {

    constructor(private paginationUtil: SimPaginationUtil) { }

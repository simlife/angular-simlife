 ...
 * If an attribute is not provided, default values will be applied (see SimModuleConfig class)
 * Have a look at the following examples
 *
 * * * * * * * * * * * * * * * * * * * * * * * * * * * *
 *
 * <sim-boolean [value]="inputBooleanVariable"></sim-boolean>
 *
 ...
 */
@Component({
    selector: 'sim-boolean',
    template: `<span
               [ngClass]="value ? classTrue : classFalse"
               [innerHtml]="value ? textTrue : textFalse">
               </span>`
})
export class SimBooleanComponent implements OnInit {
    /**
    ...
    constructor(configService: SimConfigService) {

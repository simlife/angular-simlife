...
import { SimBooleanComponent } from '../../src/component/sim-boolean.component';
import { SimConfigService } from '../../src/config.service';

function getElementHtml(element: ComponentFixture<SimBooleanComponent>): string {
    const res = element.nativeElement.querySelector('span');
    return (res && res.innerHTML) ? res.innerHTML.trim() : '';
}

function getElementAttribute(element: ComponentFixture<SimBooleanComponent>, value: string): string {
...
describe('SimBooleanComponent test', () => {

    let comp: SimBooleanComponent;
    let fixture: ComponentFixture<SimBooleanComponent>;
    ...
    beforeEach(() => {
        fixture = TestBed.createComponent(SimBooleanComponent);

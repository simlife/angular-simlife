...
import { SimResolvePagingParams } from '../../src/service/resolve-paging-params.service';
    ...
    describe('ResolvePagingParams Links Service Test', () => {
        beforeEach(() => {
            TestBed.configureTestingModule({
                providers: [
                    {
                        provide: SimPaginationUtil,
                        useValue: new SimPaginationUtil()
                    }
                ]
            });
        });

        it(`should return default when page and sort and defaultSort is undefined`, inject([SimResolvePagingParams], (service: SimResolvePagingParams) => {
